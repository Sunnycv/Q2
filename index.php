...
//тупо открываем главной страницу index.htm (по заказу фриланс)
if($url==''){$n=@filesize('index.htm');
if($n!=0){$f = fopen('index.htm',"r");}
	$data = fread($f, $n);fclose($f);clearstatcache();
echo $data.'!';exit;}
